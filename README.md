...
Copy the symbol code corresponding to the emoji expression and enter your markdown text to display the emoji expression.

Example: If you input `:blush:`, then it will show: :blush:
